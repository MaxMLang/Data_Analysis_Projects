---
title: An R Markdown document converted from "/Users/max/Documents/My_Website/Data_Analysis_Projects/Exploring
  the Bitcoin Cryptocurrency Market/notebook.ipynb"
...
# Plotting 
ax = cap10.market_cap_perc.plot.bar(title=title, color= "darkorange", bottom=0.15)
...
# Plotting
plt.bar(range(len(values)), values, tick_label=LABELS, color=width= 0.5);
plt.show()
```
